...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>ePostin Envío de paquetes en el día</title>
        ...
        $(document).ready(function(){
            ...
            **/
            ...
            $("#showCustomers").click(function(){
				...
				$( "#optCustomer" ).addClass( "active" ).addClass( "open" );
				$( "#optOrders" ).removeClass( "active" ).removeClass( "open" );
            ...
            $("#showOrders").click(function(){
				...
				$( "#optOrders" ).addClass( "active" ).addClass( "open" );
				$( "#optCustomer" ).removeClass( "active" ).removeClass( "open" );
				$( "#optOthers" ).removeClass( "active" ).removeClass( "open" );
			...
			// Gustavo
			//------------------------------------------
			$("#activeTabClient").click(function(){
				$("#tabMisDatos").click();
			});
			
			$("#activeTabMisDir").click(function(){
				$("#tabMisDirecciones").click();
			});
			
			$("#activeTabChangePass").click(function(){
				$("#tabChangePass").click();
			});
			
			
            // Muestra Tab Mis Datos
			$("#tabMisDatos").click(function(){
				$( "#tab_changePass" ).removeClass( "active" );
				$( "#tab_misDirecciones" ).removeClass( "active" );
				$( "#tab_misDatos" ).addClass( "active" );
            });

            // Muestra Tab Mis Direcciones
            $("#tabMisDirecciones").click(function(){
				$( "#tab_changePass" ).removeClass( "active" );
				$( "#tab_misDatos" ).removeClass( "active" );
				$( "#tab_misDirecciones" ).addClass( "active" );
            });
			
			// Muestra Tab Cambiar clave
            $("#tabChangePass").click(function(){
				$( "#tab_misDatos" ).removeClass( "active" );
				$( "#tab_misDirecciones" ).removeClass( "active" );
				$( "#tab_changePass" ).addClass( "active" );
            });
			//------------------------------------------
			// End - Gustavo
			//------------------------------------------
